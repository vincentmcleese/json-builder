/*
  # Update AI model and validation prompt

  1. Changes
    - Updates or creates GPT-3.5 Turbo AI model
    - Updates validation prompt with improved workflow validation logic
...
-- First delete existing validation prompt if it exists
DELETE FROM system_prompts WHERE step = 'validation';

-- Then insert the new validation prompt
