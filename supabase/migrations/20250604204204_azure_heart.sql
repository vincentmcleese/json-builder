/*
  # Fix validation prompt and AI model

  1. Changes
    - Ensure consistent model_id
    - Update validation prompt
    - Set is_active flag
*/

-- First, update the AI model to use consistent ID
UPDATE ai_models 
SET model_id = 'openai/gpt-3.5-turbo'
WHERE model_id = 'gpt-3.5-turbo';

-- Then ensure we have the correct model
